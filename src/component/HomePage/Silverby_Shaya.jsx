...
const Silverby_Shaya = () => {
    return (
        <div>
            {/* Rings.... */}
            <div>
                <div className="flex flex-wrap mt-2 bg-white text-black p-4 pl-15 gap-5 rounded shadow relative">
                    ...
                    <div className="relative flex flex-wrap gap-4 justify-center sm:justify-start w-full sm:w-auto">
